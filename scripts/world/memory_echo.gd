...
func interact(_player: Node2D) -> void:
	...
	tween.tween_property(_visual, "scale", Vector2(1.25, 1.25), 0.5)
...
func _on_revealed() -> void:
	...
	tween.tween_property(_visual, "scale", Vector2(2.25, 2.25), 0.25)
	tween.chain().tween_property(_visual, "scale", Vector2(1.45, 1.45), 0.35)
