...
### Added
- **Ellie's wireless set.** In the home base you can now tune a salvaged radio across the county's broadcasts — Rafi's honest ham signal, the looping standing-advisory, County Control's too-smooth "everyone is safe, there is no gap," the safe-roll reading the dead out as arriving, and, faint on an old line, a voice that might be Maggie's. Each fades in and out of static as you dial, and the fake-speech engine reads it aloud, coloured by its source. Story delivered by radio, not paper.
